class SubversionAT10 < Formula
  ...
  sha256 "18c8e72691e6d2e7d3137ae4ad98b9f8977cca5eb2504fab48d55e584b10eca7"
  license "Apache-2.0"
  revision 4
  ...
  #depending on casks?
  #depends_on "adoptopenjdk8" => :build
  ...
  def install
    ...
    args = %W[
      ...
      --with-apxs=no
      --with-jdk=/Library/Java/JavaVirtualMachines/adoptopenjdk-8.jdk/Contents/Home
